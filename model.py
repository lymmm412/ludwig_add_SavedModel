...
class Model:
    ...
    def train(
        ...
        model_dir =os.path.join('results',dir_list[-1])+'/model'
    ...
    def batch_evaluation(
        ...
        # the print out below will give you the name of the output node, which will be used when freezing the graph
        print('--------------------------------',output_nodes,'--------------------------')
